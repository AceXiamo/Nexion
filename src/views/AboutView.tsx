    ...
    <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ">
          <div className="space-y-3 flex flex-col">
            ...
            <div className="space-y-2 mt-auto">
              <div className="flex items-center space-x-3 px-3 py-2 rounded bg-blue-900/20 hover:bg-blue-900/30 transition-colors duration-300">
                ...
                <span className="text-xs text-blue-200/80">{t('views:about.techStack')}</span>
              </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-3 px-4 py-3 rounded bg-[#1a1a2e]/40 hover:bg-[#1a1a2e]/60 transition-all duration-300">
              ...
              <div>
                <div className="text-xs font-medium text-blue-100">{t('views:about.frontend')}</div>
                <div className="text-xs text-blue-200/60">{t('views:about.security')}</div>
              </div>
            </div>
            <div className="flex items-center space-x-3 px-4 py-3 rounded bg-[#1a1a2e]/40 hover:bg-purple-900/30 transition-all duration-300">
              ...
              <div>
                <div className="text-xs font-medium text-blue-100">{t('views:about.blockchain')}</div>
                <div className="text-xs text-blue-200/60">{t('views:about.website')}</div>
              </div>
            </div>
            <div className="flex items-center space-x-3 px-4 py-3 rounded bg-[#1a1a2e]/40 hover:bg-indigo-900/30 transition-all duration-300">
              ...
              <div>
                <div className="text-xs font-medium text-blue-100">{t('views:about.email')}</div>
                <div className="text-xs text-blue-200/60">{t('views:about.github')}</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="p-4">
        <div className="flex items-center space-x-2 mb-4">
          ...
          <h2 className="text-base font-semibold text-blue-100">{t('views:about.github')}</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          >
            <div className="flex flex-col items-center space-y-2">
              ...
              <div className="text-center">
                <div className="text-xs font-medium text-blue-100 group-hover:text-blue-50 transition-colors duration-300">{t('views:about.website')}</div>
                <div className="text-xs text-blue-200/60 mt-1">{t('views:about.productIntro')}</div>
              </div>
            </div>
          </button>
          ...
          >
            <div className="flex flex-col items-center space-y-2">
              ...
              <div className="text-center">
                <div className="text-xs font-medium text-blue-100 group-hover:text-blue-50 transition-colors duration-300">{t('views:about.github')}</div>
                <div className="text-xs text-blue-200/60 mt-1">{t('views:about.blockchain')}</div>
              </div>
            </div>
          </button>
          ...
          >
            <div className="flex flex-col items-center space-y-2">
              ...
              <div className="text-center">
                <div className="text-xs font-medium text-blue-100 group-hover:text-blue-50 transition-colors duration-300">{t('views:about.blockchain')}</div>
                <div className="text-xs text-blue-200/60 mt-1">{t('views:about.techStack')}</div>
              </div>
            </div>
          </button>
          ...
          >
            <div className="flex flex-col items-center space-y-2">
              ...
              <div className="text-center">
                <div className="text-xs font-medium text-blue-100 group-hover:text-blue-50 transition-colors duration-300">{t('views:about.changelog')}</div>
                <div className="text-xs text-blue-200/60 mt-1">{t('views:about.website')}</div>
              </div>
            </div>
          </button>
        </div>
      ...
      <div className="p-4">
        <div className="flex items-center space-x-2 mb-4">
          ...
          <h2 className="text-base font-semibold text-blue-100">{t('views:about.copyright')}</h2>
        </div>
            ...
            <div className="flex-1">
              <div className="text-blue-200/80 leading-relaxed">
                <p className="mb-2 text-sm">
                  © 2024 <span className="font-semibold bg-gradient-to-r from-blue-300 to-purple-300 bg-clip-text text-transparent">Nexion</span>. {t('views:about.copyright')}.
                </p>
                <p className="text-blue-200/70 mb-3 text-xs">{t('views:about.license')}</p>
                <div className="flex items-center space-x-3 pt-2 border-t border-[#2a2a4a]/30">
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-xs text-blue-200/60">{t('views:about.license')}</span>
                  </div>
                  <div className="flex items-center space-x-1">
                    <Icon icon="token-branded:ethereum" className="w-3 h-3 text-blue-400" />
                    <span className="text-xs text-blue-200/60">{t('views:about.techStack')}</span>
                  </div>
                </div>
              </div>
            </div>
